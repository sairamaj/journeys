...
import TestWithMockDataWithBranch from '../components/TestWithMockDataWithBranch'
...
test("List renders successfully", () => {
  render(<TestWithMockDataWithBranch data={mockData} displayUnorderedList={true} />)
  expect(screen.getByText(/fletcher/i)).toBeInTheDocument();
})

test("Ordered list renders", () => {
  render(<TestWithMockDataWithBranch data={mockData} displayUnorderedList={false} />)
...
test("Email link click handler called", async () => {
  ...
  render(<TestWithMockDataWithBranch 
              data={mockData} 
